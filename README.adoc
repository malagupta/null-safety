...
....
https://github.com/malagupta/NullSafetyInJava
....
.^a| {empty} +
*Link to content*: link:https://github.com/malagupta/NullSafetyInJava[] +
&#160;
|===
'''
...
|===
| link:assets/docs/AboutSpeakers.adoc[◀️ About: Speakers]
| &nbsp;
